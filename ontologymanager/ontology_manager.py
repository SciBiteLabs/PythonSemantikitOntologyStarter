...
__credits__ = ["James Malone"]
__license__ = "GPL"
__version__ = "1.0.1"
__email__ = "james@scbite.com"
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    print('ttl failed')
                    print(e.args)
                    raise Exception('Could not parse the file! Is it a valid RDF/OWL ontology?')
    ...
    def getAllNamedClasses(self, classPredicate="", removeBlankNodes=True):
        ...
        if not classPredicate:
            ...
            if classPredicate == "rdfs" or classPredicate == "rdf":
                ...
                raise Exception('ClassPredicate must be either rdf, rdfs or owl')
